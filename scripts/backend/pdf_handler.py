...
class ProcessPdf:
    # init ProcessPdf object; see main_back.py for more details on arguments
    ...
    #           group_no as number of "group"; default to 0 if no group selector active
    ...
    # places blank pages
    # Input:    index as index of temporary PDF-File
    #           group_no as group number to divide (you can see it as a title page for e.g. a chapter)
